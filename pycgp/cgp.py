...
# 	def __init__(self, genome, num_inputs, num_outputs, num_cste, num_cols, num_rows, library, recurrency_distance = 1.0, recursive = False, const_min = 0, const_max = 255, input_shape=1, dtype='float'):
# 		""" CGP constructor, it construct the CGP object with respect of the num of inputs, outputs, cols and row
